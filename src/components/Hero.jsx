...
const Hero = () => {
    ...
    const [activeTab, setActiveTab] = useState('post'); // 'post' or 'earn'
    ...
    const handlePostTask = async () => {
        ...
        try {
            const dateString = taskData.dateOption === 'flexible'
                ? "I'm flexible"
                : `${taskData.dateOption === 'onDate' ? 'On' : 'Before'} ${taskData.selectedDate}`;
            ...
            setSubmitStatus({ type: 'success', message: 'Task posted successfully! We will contact you soon.' });
            setTaskData({
    ...
    const handleBecomeTasker = async () => {
        ...
        try {
            ...
            setSubmitStatus({ type: 'success', message: 'Application submitted! We will review and contact you soon.' });
                ...
                <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                    <div className="max-w-4xl mx-auto text-center">
                            ...
                            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white mb-4 sm:mb-6 leading-tight px-2">
                                ...
                                <span className="relative inline-block">
                                    ...
                                    <motion.div
                                        ...
                                        className="absolute bottom-1 sm:bottom-2 left-0 h-2 sm:h-3 bg-yellow-400 opacity-30"
                                    />
                                </span>
                            </h1>
                        </motion.div>
                        ...
                        <motion.p
                            ...
                            className="text-base sm:text-lg md:text-xl text-white/90 mb-8 sm:mb-10 max-w-2xl mx-auto px-2"
                        >
                        ...
                        <motion.div
                            ...
                            className="flex flex-col gap-3 sm:gap-4 justify-center mb-8 sm:mb-12 px-4 sm:px-0"
                        >
                            <button
                                onClick={() => openModal('post')}
                                className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold text-base sm:text-lg rounded-full transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                            >
                            ...
                            <button
                                ...
                                className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-transparent border-2 border-white text-white hover:bg-white hover:text-blue-600 font-bold text-base sm:text-lg rounded-full transition-all duration-300"
                            >
                        ...
                        >
                            {[
                                ...
                                <div
                                    key={index}
                                    className="flex items-center justify-center gap-2 text-white/90 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full text-sm sm:text-base w-full sm:w-auto"
                                >
                                    <feature.icon className="w-4 h-4 sm:w-5 sm:h-5 text-yellow-300 flex-shrink-0" />
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between p-4 border-b border-gray-100">
                                <div className="flex gap-2">
                                    <button
                                        onClick={() => { setActiveTab('post'); setSubmitStatus({ type: '', message: '' }); }}
                                        className={`px-4 py-2 rounded-full font-semibold transition-all ${activeTab === 'post'
                                            ? 'bg-blue-600 text-white'
                                            : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                                            }`}
                                    >
                                        <FiEdit3 className="inline w-4 h-4 mr-1" />
                                        Post a task
                                    </button>
                                    <button
                                        onClick={() => { setActiveTab('earn'); setSubmitStatus({ type: '', message: '' }); }}
                                        className={`px-4 py-2 rounded-full font-semibold transition-all ${activeTab === 'earn'
                                ...
                                <AnimatePresence mode="wait">
                                    {activeTab === 'post' ? (
                                        ...
                                        >
                                            ...
                                            {/* Title */}
                                            <div className="mb-4">
                                                <label className="block text-sm font-medium text-gray-700 mb-1">Title & Date *</label>
                                                ...
                                                <div className="grid grid-cols-3 gap-2 mb-2">
                                                    {[
                                                        ...
                                                        <button
                                                            key={option.id}
                                                            type="button"
                                                            onClick={() => handleTaskInputChange('dateOption', option.id)}
                                                            className={`py-2 text-sm font-medium rounded-lg border-2 transition-all ${taskData.dateOption === option.id
                                                ...
                                                {taskData.dateOption !== 'flexible' && (
                                                    <div className="relative">
                                                        ...
                                                        <input
                                                            ...
                                                            onChange={(e) => handleTaskInputChange('selectedDate', e.target.value)}
                                                            className="w-full pl-11 pr-4 py-2.5 border-2 border-gray-200 rounded-xl focus:border-blue-500 outline-none"
                                                        />
                                                    </div>
                                                )}
                                            </div>
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => handleTaskInputChange('location', e.target.value)}
                                                        className="w-full pl-11 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-500 outline-none"
                                                    />
                                                </div>
                                            </div>
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => handleTaskInputChange('budget', e.target.value)}
                                                        className="w-full pl-11 pr-4 py-3 border-2 border-gray-200 rounded-xl focus:border-blue-500 outline-none"
                                                    />
                                                </div>
                                            </div>
                                            ...
                                            <div className="border-t pt-4 mt-4">
                                                ...
                                                <div className="space-y-3">
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => handleTaskInputChange('email', e.target.value)}
                                                        className="w-full px-4 py-2.5 border-2 border-gray-200 rounded-xl focus:border-blue-500 outline-none"
                                                    />
                                                    <input
                                                        type="tel"
                                                        ...
                                                        onChange={(e) => handleTaskInputChange('phone', e.target.value)}
                                                        className="w-full px-4 py-2.5 border-2 border-gray-200 rounded-xl focus:border-blue-500 outline-none"
                                                    />
                                                </div>
                                            </div>
                                            ...
                                            {submitStatus.message && (
                                                <div className={`mt-4 p-3 rounded-xl text-sm ${submitStatus.type === 'success'
                                            ...
                                            <button
                                                ...
                                                className="w-full mt-5 py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl transition-all flex items-center justify-center gap-2 disabled:opacity-70"
                                            >
                                                {isSubmitting ? (
                                                    <><FiLoader className="w-5 h-5 animate-spin" /><span>Posting...</span></>
                                                ) : (
                                                    <><span>Post your task for free</span><FiArrowRight className="w-5 h-5" /></>
                                                )}
                                            </button>
                                        </motion.div>
                                    ) : (
                                        ...
                                        >
                                            ...
                                            {/* Status */}
                                            {submitStatus.message && (
                                                <div className={`mt-4 p-3 rounded-xl text-sm ${submitStatus.type === 'success' ? 'bg-green-50 text-green-700 border border-green-200' : 'bg-red-50 text-red-700 border border-red-200'}`}>
                                                    {submitStatus.message}
                                                </div>
                                            )}
                                            ...
                                            <button
                                                ...
                                                disabled={isSubmitting}
                                                className="w-full mt-5 py-4 bg-green-600 hover:bg-green-700 text-white font-bold rounded-xl transition-all flex items-center justify-center gap-2 disabled:opacity-70"
                                            >
                                                {isSubmitting ? (
                                                    <><FiLoader className="w-5 h-5 animate-spin" /><span>Submitting...</span></>
                                                ) : (
